...
describe("/", () => {
  ...
  describe("GET /api/articles/:article_id", () => {
    ...
    it("status:400, responds with custom error when article_id invalid", () => {
      return request(app)
  ...
  describe(" PATCH /api/articles/:article_id", () => {
    ...
    it("status:400 when request body has invalid/missing key or value", () => {
      return request(app)
        .patch("/api/articles/13")
        .send({ "invalid_key": "notAnInt" })
        .expect(400)
    });
    it("status:400 when request body non-existent", () => {
      return request(app)
        .patch("/api/articles/13")
        .expect(400)
    });
    ...
    it("status:200, successfully responds with all the correct comments for specified article", () => {
      return request(app)
        ...
        .then(data => {
          ...
          expect(data.body.comments[3]).to.have.all.keys(
            "comment_id",
            "author",
            "article_id",
            "body",
    ...
    it("status:200, successfully responds with all articles", () => {
      return request(app)
        ...
        .then(data => {
          ...
          expect(data.body.articles[2]).to.have.all.keys(
            "article_id",
            "title",
            "body",
            "votes",
